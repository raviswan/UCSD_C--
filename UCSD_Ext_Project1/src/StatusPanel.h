...
namespace Project1
{
    ...
    public:
        ...
        //---------------------------------------------------------------------
        // SUMMARY
        //      Constructor.  Initialize the status panel's stream to the given
        //      ostream.  Messages output by the status panel will be sent to
        //      the ostream.
        //
        // RESOURCES
        //      None
        ...
        //---------------------------------------------------------------------
        // SUMMARY
        //      Send the message string for the given message code to this
